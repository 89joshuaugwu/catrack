...
const NAV: Record<Role, NavItem[]> = {
  ...
  lecturer: [{ href: "/dashboard/lecturer/quizzes", label: "Quiz library", icon: ClipboardCheck }, { href: "/dashboard/lecturer/ca-overview", label: "Class progress", icon: GraduationCap }],
  admin: [{ href: "/dashboard/admin/courses", label: "Courses", icon: BookOpen }, { href: "/dashboard/admin/lecturers", label: "Lecturers", icon: Users }],
};
